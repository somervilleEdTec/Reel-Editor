...
- No audio leaves your machine when using the local backend.
- Cloud transcription (Azure) is optional and only runs when you choose it.

By continuing, you consent to downloading model weights for local use.
