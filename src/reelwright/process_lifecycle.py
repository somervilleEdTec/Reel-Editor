"""Public lifecycle API: PID file plus targeted Reelwright process shutdown."""
...
from reelwright.paths import install_root
from reelwright.pid_file import (
    API_NAME,
    clear_pid_file,
    pid_file_path,
    read_pid_file,
...
from reelwright.process_kill import process_alive, terminate_process_tree
from reelwright.process_scan import ProcessInfo, list_processes

__all__ = [
    "API_NAME",
    "clear_pid_file",
    "kill_reelwright_processes",
    "pid_file_path",
    "process_alive",
    "read_pid_file",
...
APP_NAMES = ("reelwright.exe", "reelwright-api.exe", "reelwright", "reelwright-api")
