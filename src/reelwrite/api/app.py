...
app = FastAPI(title="Reelwrite", version="2.0.0")
...
from reelwrite.api.assembly_routes import router as assembly_router
from reelwrite.api.audio_routes import router as audio_router
from reelwrite.api.edit_routes import router as edit_router
from reelwrite.api.fs_routes import router as fs_router
...
from reelwrite.api.snapshot_routes import router as snapshot_router
from reelwrite.api.source_routes import router as source_router
from reelwrite.api.title_routes import router as title_router
...
def _save(p: Project) -> None:
    from reelwrite.api.undo import save_with_undo
...
def open_project(body: OpenBody):
    from reelwrite.api.undo import reset_history
...
def safezones():
    ...
    ref = resources.files("reelwrite").joinpath("config/safezones.json")
